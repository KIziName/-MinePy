...
# Физика в пикселях в секунду (было за кадр при 60 FPS → умножено на 60)
GRAVITY = 0.85 * 60        # 51.0   пикселей/сек²
PLAYER_SPEED = 5.2 * 60    # 312.0  пикселей/сек
JUMP_FORCE = -11.5 * 60    # -690.0 пикселей/сек
